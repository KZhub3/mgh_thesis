$PROBLEM Pyronaridine -- drug-drug interaction CL
$INPUT 		ID 
			DATE = DROP 						
			TIME 						
...
$PK			
			...
			CL = THETA(3) * (WT/58.5)**0.75 * EXP(ETA(3)) * COV1  						; Individual clearance
...
$TABLE ID TIME TAD EVID NDDV DV MDV CMT ADMIN PQFLAG SEX HT WT IPRED CWRES IWRES NOPRINT ONEHEADER FILE=mytab73
