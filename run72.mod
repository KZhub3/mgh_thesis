$PROBLEM Pyronaridine -- drug-drug interaction MTT
$INPUT 		ID 
			DATE = DROP 						
			TIME 						
...
$PK			
			...
			MTT = THETA(2) * EXP(ETA(2)) * COV1												; Mean transit time
...
$TABLE ID TIME TAD EVID NDDV DV MDV CMT ADMIN PQFLAG SEX HT WT IPRED CWRES IWRES NOPRINT ONEHEADER FILE=mytab72
