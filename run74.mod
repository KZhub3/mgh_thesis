$PROBLEM Pyronaridine -- drug-drug interaction V2
$INPUT 		ID 
			DATE = DROP 						
			TIME 						
...
$PK			
			...
			V2 = THETA(4) * (WT/58.5)**1 * EXP(ETA(4)) * COV1									; Individual volume for central compartment
...
$TABLE ID TIME TAD EVID NDDV DV MDV CMT ADMIN PQFLAG SEX HT WT IPRED CWRES IWRES NOPRINT ONEHEADER FILE=mytab74
