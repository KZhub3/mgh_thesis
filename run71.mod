$PROBLEM Pyronaridine -- drug-drug interaction F1
$INPUT 		ID 
			DATE = DROP 						
			TIME 						
...
$TABLE ID TIME TAD EVID NDDV DV MDV CMT ADMIN PQFLAG SEX HT WT IPRED IWRES NOPRINT ONEHEADER FILE=mytab71
