$PROBLEM Pyronaridine -- drug-drug interaction Q1
$INPUT 		ID 
			DATE = DROP 						
			TIME 						
...
$PK			
			...
			Q1 = THETA(6) * (WT/58.5)**0.75 * EXP(ETA(6)) * COV1	
...
$TABLE ID TIME TAD EVID NDDV DV MDV CMT ADMIN PQFLAG SEX HT WT IPRED CWRES IWRES NOPRINT ONEHEADER FILE=mytab76
