$PROBLEM Pyronaridine -- drug-drug interaction Q2
$INPUT 		ID 
			DATE = DROP 						
			TIME 						
...
$PK			
			...
			Q2 = THETA(8) * (WT/58.5)**0.75 * EXP(ETA(8)) * COV1
...
$TABLE ID TIME TAD EVID NDDV DV MDV CMT ADMIN PQFLAG SEX HT WT IPRED CWRES IWRES NOPRINT ONEHEADER FILE=mytab78
